...
PORT = "32321"
CONFIG_DIR = "../../Qwen-family/model-1b-for-data"
DATA_DIR = "../../data/washed_data_0520/train" # 2879 * 4096 = 11,792,384
# DATA_DIR = "/inspire/hdd/global_user/p-shangli/DCLM" # 2879 * 4096 = 11,792,384
...
def prepare_data(local_rank, world_size):
    ...
    # dataset = DomainData_DCLM(DATA_DIR, DATA_DOMAIN, SEQ_LEN, tokenizer)
    # dataset = DomainData_reviews(DATA_DIR, DATA_DOMAIN, SEQ_LEN, tokenizer)
    dataset = DomainData_20B(DATA_DIR, DATA_DOMAIN, SEQ_LEN, tokenizer)
