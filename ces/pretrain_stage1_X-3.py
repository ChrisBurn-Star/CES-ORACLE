...
def train(model, num_epochs, dataset, dataset_pre):
    ...
    print(f'12 layers:{replay_12}; decoder_replay:{replay_decoder}; tube between layers:{replay_12_through}; data_replay:{replay_data}; use pca:{use_pca}; test:{test}; all_through:{all_thorugh}; decoder_self:{decoder_self}')
    file_name0 = "logs/"+'output-12_layers_%d-decoder_replay%d-tube_between_layers%d-data_replay%d-use_pca%d-test%d-all_through%d-decoder_self%d'%(replay_12, replay_decoder, replay_12_through, replay_data, use_pca,test,all_thorugh, decoder_self)
    ...
    file_name = './output-'+'12_layers_%d-decoder_replay%d-tube_between_layers%d-data_replay%d-use_pca%d-test%d-all_through%d-decoder_self%d'%(replay_12, replay_decoder, replay_12_through, replay_data, use_pca,test,all_thorugh, decoder_self)
