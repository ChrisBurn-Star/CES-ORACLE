...
def finetune(model:BERTForCLS, dataset: medical_abstract,k,EPOCH,task,CKPTS,lr,seed,LEGAL):
    ...
    # load_checkpoint_and_dispatch(model0, '/home/jxzhou/PLM_PER/BERT-CL-main/MODELS_REBUTALL/BERT_MED_0801-2-checkpoints%d'%CKPTS,device_map={"":device})
    load_checkpoint_and_dispatch(model0, '/home/jxzhou/PLM_PER/BERT-CL-main/MODELS_0521/BERT-0521',device_map={"":device})
    ...
    writer = SummaryWriter('/home/jxzhou/PLM_PER/BERT-CL-main/rebuttal_finetune/BERT_0521-task%s'%task)
...
if __name__ == "__main__":
    ...
    for i in datasets:
        print(i)
        finetune(model, datasets[i],k,EPOCH,i,80000,1e-4,seed,LEGAL)
    # for ck in range(100,1001,100):
    #     for i in datasets:
    #         print(i)
    #         finetune(model, datasets[i],k,EPOCH,i,ck,1e-4,seed,LEGAL)
