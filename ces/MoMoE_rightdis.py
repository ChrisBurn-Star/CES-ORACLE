...
def train(model, num_epochs, dataset, device, dataset2):
    ...
    writer = SummaryWriter('tensorboard_0119/0128_MoMoE_batch64_seq128_2t4e_LAR_correctdistribution')
    ...
    for epoch in range(num_epochs):
        ...
        for i, (batch1,batch2) in enumerate(zip(train_loader,train_loader2)):
            ...
            if steps%100000 == 0 and steps>0:
                ...
                torch.save(model,'0128_MoMoE_batch64_seq128_2t4e_LAR_correctdistribution_%dsteps.pth'%steps)
    ...
    torch.save(model,'0128_MoMoE_batch64_seq128_2t4e_LAR_correctdistribution.pth')
...
if __name__ == "__main__":
    ...
    model = base_models.MoMoE_0128(config=config)
